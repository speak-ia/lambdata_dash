...
export function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (!success) {
      setError("Connexion Google échouée ou compte non-administrateur.");
    }
    setIsLoading(false);
  };
            ...
            <div className="px-8 pt-8 pb-8">
              ...
              <div className="w-full">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 h-10 border border-gray-200 rounded-xl text-sm text-gray-600 hover:bg-gray-50 transition-colors cursor-pointer"
                >
